...
namespace PaintCore
{
	...
	public abstract class CwPaintableTextureMonitorMask : CwPaintableTextureMonitor
	{
		...
		/// <summary>If you want to manually specify the total amount of pixels, you can disable this.</summary>
		public bool CalculateTotal { set { calculateTotal = value; } get { return calculateTotal; } } [SerializeField] private bool calculateTotal = true;
...
namespace PaintCore
{
	...
	public class CwPaintableTextureMonitorMask_Editor : CwPaintableTextureMonitor_Editor
	{
		protected override void OnInspector()
		{
			...
			EndError();
			Draw("calculateTotal", "If you want to manually specify the total amount of pixels, you can disable this.");
