Shader "Quibli/Stylized Lit Copy"
{
    Properties
    {
        ...
        [Space(10)]
        // Note: Vertex colors are now always enabled for RGB usage
        [Toggle(DR_VERTEX_COLORS_ON)] _VertexColorsEnabled("Enable Vertex Colors", Int) = 1
    ...
    SubShader
    {
        Tags
        {
            ...
            "pb_ColorTarget" = "1"  // Tell Polybrush this shader supports vertex colors
        }
        LOD 300
        ...
        Pass
        {
            ...
            struct VertexInput
            {
                ...
                float4 color : COLOR;  // Add vertex color support
